    ...
    let
      ...
      releaseAssets = {
        "x86_64-linux" = {
          ...
          hash = "sha256-bSWKZjL8tjpd6i/LvHFmXXrpeAeuMDpEdBzvWYtyNSE=";
        };
        "aarch64-linux" = {
          urlName = "qbz_${version}_aarch64.tar.gz";
          hash = "sha256-KbJimpGuvAhJ7bcK6/vD+uEmMP3z01nSVeFfrI3NVP8=";
        };
        "aarch64-darwin" = {
          urlName = "QBZ_${version}_aarch64.dmg";
          hash = "sha256-Q3oR5HyNQxJP/pNFOdUFfR4iYbCArEF46b8L4NLdcFU=";
        };
        "x86_64-darwin" = {
          urlName = "QBZ_${version}_x64.dmg";
          hash = "sha256-0e44w7TbpgoIKcXzJQ7LiW4jSUPyjGZ2X22Z8sTVCl4=";
        };
      };
